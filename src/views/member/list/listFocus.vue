...
<template>
  <section class="home public-body">
    ...
    >
      ...
      <el-table-column align="center" prop="pastDay" label="重置章节">
        <template slot-scope="scope">
          {{ scope.row.yibei_course ? scope.row.yibei_course.title : "-" }}
        </template>
      </el-table-column>

      <el-table-column align="center" prop="pastDay" label="重置到小节">
        <template slot-scope="scope">
          {{
      ...
      <el-table-column align="center" label="重置时间">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="操作" width="190" fixed="right">
        <template slot-scope="scope">
          ...
          <Mirror :memberId="scope.row.memberid" />
        </template>
      </el-table-column>
    </el-table>
