        ...
        >
          ...
          <div class="title-right">
            <div class="title-right-icon">
              <i
                v-if="son.studystep.indexOf(0) > -1"
                class="title-right-icon__video"
                title="视频学习"
              ></i>
              <i
                v-if="son.studystep.indexOf(1) > -1"
                class="title-right-icon__chinese"
                title="关键词中英"
              ></i>
              <i
                v-if="son.studystep.indexOf(3) > -1"
                class="title-right-icon__english"
                title="关键词英"
              ></i>
              <i
                v-if="son.studystep.indexOf(5) > -1"
                class="title-right-icon__test"
                title="单元测试"
              ></i>
            </div>
            <el-button
