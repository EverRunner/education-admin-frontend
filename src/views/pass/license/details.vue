...
<template>
  <section class="member-details">
    <el-breadcrumb separator="/" v-if="$route.query.type == 'order'">
      <el-breadcrumb-item class="on">订单</el-breadcrumb-item>
      <el-breadcrumb-item class="on">考过生服务订单</el-breadcrumb-item>
      ...
      <div class="info">
        <el-row>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <div class="info-item">
              <em>姓名：</em
              ><span @click="handleGoto" class="on" style="cursor: pointer;">{{
                info.username || "-"
              }}</span>
            </div>
          </el-col>
        ...
        <el-tabs v-model="activeName" type="card">
          ...
          <el-tab-pane label="电子协议" name="second">
            <ul class="tabs-list">
              <li>
                <h5>姓名：</h5>
                <p @click="handleGoto" class="text" style="cursor: pointer;">
                  {{ info.username || "-" }}
                </p>
              </li>
              <li>
